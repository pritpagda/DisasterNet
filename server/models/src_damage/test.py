...
def test_model(csv_path, image_dir, model_path, batch_size=16, num_classes=3):
    ...
    test_dataset = DamageDataset(csv_path, image_dir, val_transform)
...
if __name__ == '__main__':
    TEST_CSV_PATH = '../data/processed_damage/test.csv'
    IMAGE_DIR = '../data/'
    MODEL_PATH = 'best_damage_model.pth'

    test_model(TEST_CSV_PATH, IMAGE_DIR, MODEL_PATH, batch_size=16, num_classes=3)
